...
export interface ValidatedNextApiRequest<B = unknown, Q = unknown>
  extends NextApiRequest {
  parsedBody: B
  parsedQuery: Q
}

export interface ValidatedNextRequest<B = unknown, Q = unknown>
  extends NextRequest {
  parsedBody: B
  parsedQuery: Q
}
...
export type CallbackTypes<B, Q> = {
  edge: (
    req: ValidatedRequestTypes<B, Q>['edge'],
    res: NextResponse
  ) => Promise<NextResponse | void> | NextResponse | void
  nodejs: (
    req: ValidatedRequestTypes<B, Q>['nodejs'],
    res: NextApiResponse
  ) => Promise<void> | void
}
